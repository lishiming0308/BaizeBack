...
public class CRC16 {
    static int[] u16CrcTalbe = { 0x0000, 0xC0C1, 0xC181, 0x0140, 0xC301, 0x03C0, 0x0280, 0xC241, 0xC601, 0x06C0, 0x0780,
    ...
    public static int Crc16(byte[] InDataAddr) {
        int InDataLen = InDataAddr.length;
        int u16CRC = 0x0000ffff;
        int index;
        int i = 0;

        while ((InDataLen--) != 0) {
            index = ((u16CRC) ^ (InDataAddr[i])) & 0xff;
            u16CRC = (u16CRC >> 8) ^ u16CrcTalbe[index];
            i++;
        }
